...
class DiscordUser(DefaultDatabaseModel):
    ...
    @classmethod
    def create_new_admin(cls, bot_owner: discord.Member, 
                              guildname: peewee.CharField,
                              admin: peewee.BooleanField = True):
        return cls.create(discord_id=bot_owner.id,
